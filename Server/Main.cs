...
namespace Server
{
	...
	public static class Core
	{
		...
		public static void Main( string[] args )
		{
			...
			Console.WriteLine("FunUO - [https://github.com/funuo/] Version {0}.{1}.{2}.{3}", ver.Major, ver.Minor, ver.Build, ver.Revision);
			//Console.WriteLine("Core: Running on .NET Core Version {0}.{1}.{2}", Environment.Version.Major, Environment.Version.Minor, Environment.Version.Build);
